            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('post.store')}}" enctype="multipart/form-data">
                        ...
                        <input type="text" class="form-control my-2" id="title" name="title" aria-describedby="emailHelp" placeholder="Enter name">
                        @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control my-2" name="sub_description" id="sub_description" cols="30" rows="10"></textarea>
                        </div>

                        <div class="form-group">
                            <label for="description">Description</label>
                            <textarea class="form-control my-2" name="description" id="description" cols="30" rows="30"></textarea>
                            @error('description')
                                <div class="text-danger">{{ $slug }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group row my-4">
                            ...
                            @foreach ($tags as $tag)
                                <div class="form-check form-check-inline col-md-3 my-2 mx-2">
                                    <input class="form-check-input" type="checkbox" name="tags_id[]" value="{{$tag->id}}" id="{{$tag->name}}">
