            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('tag.update', ['tag' => $tag])}}">
                        ...
                        <input value="{{$tag->name}}" type="text" class="form-control my-2" id="name" name="name" aria-describedby="emailHelp" placeholder="Enter name">
                        @error('name')
                        ...
                        <input type="text" value="{{$tag->slug}}" name="slug" class="form-control my-2" id="slug" placeholder="Slug">
                        @error('slug')
                        ...
                        <input type="number" value="{{$tag->order_by}}" name="order_by" class="form-control my-2" id="orderby" placeholder="Order By">
                        @error('order_by')
